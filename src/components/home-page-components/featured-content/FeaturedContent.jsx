      ...
      <div className="content-grid">
        <div className="featured-teaser">
          ...
          <div className='featured-text'>
            ...
            <p>Tired of guessing what’s for dinner? Meal Prep Pro helps you search recipes, save favorites, 
              and auto-build your shopping list — all in one sleek, secure app. Built with React, Node.js, and MongoDB, 
              it’s designed for food lovers who crave simplicity. Tech meets taste. Let’s cook smarter.</p>
